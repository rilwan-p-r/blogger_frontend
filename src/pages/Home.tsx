...
const Home = () => {
  ...
  return (
    <>
      ...
      <button
        className="fixed bottom-6 right-6 bg-gradient-to-l from-blue-800 to-blue-300 text-white rounded-full p-4 flex items-center gap-2 shadow-lg hover:bg-blue-700 transition-colors"
